...
\columnratio{0.5,0.5} % The relative ratios of the two columns in the CV
...
\newcommand{\educationentry}[8]{
	...
	\expandafter\ifstrequal\expandafter{#4}{}{}{& {\small\textsc{#4}}\\}
	\expandafter\ifstrequal\expandafter{#5}{}{}{& {\small\textsc{#5}}\\} % Department
	\expandafter\ifstrequal\expandafter{#6}{}{}{& \small\textsc{GPA: #6}\\} % GPA
	\expandafter\ifstrequal\expandafter{#7}{}{}{& \small\textsc{Thesis Title: #7}\\} % Department
