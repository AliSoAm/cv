...
\setlength\columnsep{0.02\textwidth} % Specify the amount of space between the columns
...
\newcommand{\workposition}[5]
{
  ...
  \raggedright\expandafter\ifstrequal\expandafter{#3}{}{}{{\large #3}\\} % Employer
...
\newcommand{\educationentry}[8]{
  ...
  \expandafter\ifstrequal\expandafter{#3}{}{}{\small\textsc{Thesis Title} & \small{#3}\\} % Department
  \expandafter\ifstrequal\expandafter{#4}{}{}{& {\small\textsc{#4}}\\} % Honours, achievements or distinctions (e.g. first class honours)
  \expandafter\ifstrequal\expandafter{#5}{}{}{& {\small\textsc{#5}}\\}
  \expandafter\ifstrequal\expandafter{#6}{}{}{& {\small\textsc{#6}}\\} % Department
  \expandafter\ifstrequal\expandafter{#7}{}{}{& \small\textsc{GPA: #7}\\} % GPA
  \expandafter\ifstrequal\expandafter{#8}{}{}{& \textit{#8}\\[6pt]} % Institution
}
...
\newcommand{\taentry}[4]
{
  {\raggedleft \textsc{#1\expandafter\ifstrequal\expandafter{#2}{}{}{\hspace{6pt}\footnotesize{(#2)}}} \\}
  \raggedright\expandafter\ifstrequal\expandafter{#3}{}{}{{\large #3} \\}
  \raggedright\expandafter\ifstrequal\expandafter{#4}{}{}{\raggedright Instructor: {\textbf{#4}} \\}
  [4pt]
}
