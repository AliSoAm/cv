...
\begin{document}
  ...
  \section{تحصیلات}
    ...
    \cventry{۱۳۹۵-۱۳۹۸}{کارشناسی ارشد}{دانشگاه تهران}{دانشکده مهندسی برق و کامپیوتر}{}{مهندسی برق (شبکه‌های مخابراتی) معدل ۱۸٫۱۸}
  \vspace{-5mm}
  \section{دروس منتخب}
  ...
  \section{مهارت‌ها}
    ...
    \cvlistitem{آشنایی با زبان‌های برنامه‌نویسی \lr{Ruby}، \lr{Javascript} و \lr{Lua}}
  ...
  \vspace{-5mm}
  \section{تألیفات}
    \cvlistitem{تخصیص منابع پردازشی لبه در شبکه‌های اینترنت اشیاء (کنفرانس ملی انفورماتیک ایران)}
    \cvlistitem{}

  \vspace{-5mm}
  \section{مسئولیت‌ها و سوابق کاری}
    \cvlistitem{دستیار آموزشی درس مبانی کامپیوتر (پاییز ۹۴و ۹۵)}
    \cvlistitem{دستیار آموزشی درس شبکه‌های کامپیوتری (بهار ۹۸)}
    \cvlistitem{دستیار آموزشی  درس بازشناسی الگو (پاییز ۹۸)}
    \cvlistitem{توسعه دهنده backend در شرکت کافه بازار (از مهر ۱۳۹۸)
      \begin{itemize}
        \item -
